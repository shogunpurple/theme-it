...
If you find a theme you like and want to add it to your CSS, its much easier to just take the theme configuration, and generate the CSS using theme-its **command line interface**.
